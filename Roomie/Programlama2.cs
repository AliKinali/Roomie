...
{
    public partial class Programlama2 : Form
    {
        public Programlama2()
        {
            InitializeComponent();
        ...
        private void mesajGonder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string kayit = "insert into Programlama2(MESAJGONDEREN,MESAJICERIK) values (@MESAJGONDEREN,@MESAJICERIK)";
                ...
                this.programlama2TableAdapter1.Fill(this.roomieDataSet.Programlama2);
                textMesaj.Text = "";
                gönderildi.Show();
                baglanti.Close();
        ...
        {
            baglanti.Open();
            SqlCommand komutsil = new SqlCommand("Delete From Programlama2", baglanti);
        ...
        private void Programlama2_Load(object sender, EventArgs e)
        {
            // TODO: Bu kod satırı 'roomieDataSet.Programlama2' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.programlama2TableAdapter1.Fill(this.roomieDataSet.Programlama2);
            // TODO: Bu kod satırı 'bitirmeProjesiDataSet.Programlama2' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
